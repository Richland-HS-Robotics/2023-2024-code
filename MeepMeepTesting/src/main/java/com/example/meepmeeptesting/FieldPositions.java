...
public class FieldPositions {
    ...
    public static Vector2d boardPosition(Alliance alliance, VisionState visionState) {
        switch (alliance) {
            case RED:
                switch (visionState) {
                    case LEFT:
    ...
    public static Vector2d tapePosition(Alliance alliance, StartSide startSide){
        switch (alliance){
            case RED:
                switch (startSide){
                    case NEAR:
